  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ).animate().fadeIn(delay: 0.8.seconds, duration: 0.7.seconds),
        Text('INTO THE UNKNOWN', style: TextStyles.h3)
        .animate().fadeIn(delay: 1.seconds, duration: 0.7.seconds),
      ],
    );
  }
}
      ...
      children: [
        _DifficultyBtn(
          ...
          onHover: (over) => onDifficultyFocused(over ? 0 : null),
            ...
            .animate().fadeIn(delay: 1.3.seconds, duration: 0.35.seconds)
        ...
        _DifficultyBtn(
          ...
          onHover: (over) => onDifficultyFocused(over ? 1 : null),
            ...
            .animate().fadeIn(delay: 1.5.seconds, duration: 0.35.seconds)
            .slide(begin: const Offset(0, 0.2),),
        _DifficultyBtn(
          label: 'Hardcore',
          ...
          onHover: (over) => onDifficultyFocused(over ? 2 : null),
            ...
            .animate().fadeIn(delay: 1.7.seconds, duration: 0.35.seconds)
            .slide(begin: const Offset(0, 0.2),),
        const Gap(20),
      ],
    );
